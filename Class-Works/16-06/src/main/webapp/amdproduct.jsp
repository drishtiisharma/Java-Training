    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Add, Modify, Delete Product Page</h5>
            ...
            <form class="form-signin" action="AMDProductServlet" method="post">
              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="Produt ID" name="pid" required autofocus>
                <label for="inputEmail">Produt ID</label>
              </div>

              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="Produt Name" name="pname" required autofocus>
                <label for="inputEmail">Produt Name</label>
              </div>
              
              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="Produt Price" name="price" required autofocus>
