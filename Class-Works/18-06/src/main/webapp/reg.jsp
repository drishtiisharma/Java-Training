      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="AddNewUserSevlet" method="post" enctype="multipart/form-data">
			...
			<div class="form-label-group">
                <input type="file" id="inputPassword" accept="image/*" class="form-control" name="fpic" required>
                <label for="inputPassword">Select Photo</label>
              </div>
