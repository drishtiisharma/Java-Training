...
public class EmployeeDeleteForm extends JFrame implements ActionListener{
	JLabel l1,l2,l3;
	JTextField t1,t2,t3;
	JButton b1,b2,b3;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1) {
			if(db.addEmployee(emp)) {
				...
				t2.setText("Failed to delete record");
			}
		}
		if(e.getSource()==b2) {
			t1.setText("");
...
public static void main(String[] args) {
	EmployeeDeleteForm eif= new EmployeeDeleteForm();
	eif.setVisible(true);
